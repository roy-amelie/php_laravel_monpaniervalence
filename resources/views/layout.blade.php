                ...
                <ul class="navbar-nav">
                    <button class="btn btn-outline-secondary">
                        <li class="nav-item">
                            ...
                            <a class="nav-link" href="#">Mode & Accessoires<span class="sr-only">(current)</span></a>
                        </li>
                    </button>
                    <button class="btn btn-outline-secondary">
                        <li class="nav-item">
                            <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="bi bi-emoji-heart-eyes" viewBox="0 0 16 16">
                                <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/>
                                <path d="M11.315 10.014a.5.5 0 0 1 .548.736A4.498 4.498 0 0 1 7.965 13a4.498 4.498 0 0 1-3.898-2.25.5.5 0 0 1 .548-.736h.005l.017.005.067.015.252.055c.215.046.515.108.857.169.693.124 1.522.242 2.152.242.63 0 1.46-.118 2.152-.242a26.58 26.58 0 0 0 1.109-.224l.067-.015.017-.004.005-.002zM4.756 4.566c.763-1.424 4.02-.12.952 3.434-4.496-1.596-2.35-4.298-.952-3.434zm6.488 0c1.398-.864 3.544 1.838-.952 3.434-3.067-3.554.19-4.858.952-3.434z"/>
                            </svg>
                            <a class="nav-link" href="#">Beauté & Bien-être</a>
                        </li>
                    </button>
                    <button class="btn btn-outline-secondary">
                        <li class="nav-item">
                            ...
                            <a class="nav-link" href="#">Maison & Deco</a>
                        </li>
                    </button>
                    <button class="btn btn-outline-secondary">
                        <li class="nav-item">
                    ...
                    <button class="btn btn-outline-secondary">
                        <li class="nav-item">
                            <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="bi bi-palette" viewBox="0 0 16 16">
                                <path d="M8 5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3zm4 3a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3zM5.5 7a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0zm.5 6a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3z"/>
                                <path d="M16 8c0 3.15-1.866 2.585-3.567 2.07C11.42 9.763 10.465 9.473 10 10c-.603.683-.475 1.819-.351 2.92C9.826 14.495 9.996 16 8 16a8 8 0 1 1 8-8zm-8 7c.611 0 .654-.171.655-.176.078-.146.124-.464.07-1.119-.014-.168-.037-.37-.061-.591-.052-.464-.112-1.005-.118-1.462-.01-.707.083-1.61.704-2.314.369-.417.845-.578 1.272-.618.404-.038.812.026 1.16.104.343.077.702.186 1.025.284l.028.008c.346.105.658.199.953.266.653.148.904.083.991.024C14.717 9.38 15 9.161 15 8a7 7 0 1 0-7 7z"/>
                            </svg>
                            <a class="nav-link" href="#">Culture & Loisirs</a>
                        </li>
                    </button>
                    <button class="btn btn-outline-secondary">
                        <li class="nav-item">
                    ...
                    <button class="btn btn-outline-secondary">
                        <li class="nav-item">
                            ...
                            <a class="nav-link" href="#">Services & Divers</a>
                        </li>
                    </button>
                </ul>
            </div>
