...
<head>
    ...
    <title>Mon Panier Valence</title>
...
<header>
    <div class="d-flex justify-content-center">
        <a href="/" class="d-flex justify-content-center">
            <img src="{{url('/img/logo.png')}}" style="width: 25%" alt="Mon Panier Valence Logo">
        </a>
    </div>
    <div class="d-flex justify-content-center">
                ...
                <ul class="navbar-nav">
                    <button class="btn btn-outline-secondary">
                        <li class="nav-item">
                            ...
                            <a class="nav-link" href="{{url('categories/1')}}">Mode & Accessoires<span
                    ...
                    <button class="btn btn-outline-secondary">
                        <li class="nav-item">
                            ...
                            <a class="nav-link" href="{{url('categories/2')}}">Beauté & Bien-être</a>
                        </li>
                    </button>
                    <button class="btn btn-outline-secondary">
                        <li class="nav-item">
                            ...
                            <a class="nav-link" href="{{url('categories/3')}}">Maison & Deco</a>
                        </li>
                    </button>
                    <button class="btn btn-outline-secondary">
                        <li class="nav-item">
                            ...
                            <a class="nav-link" href="{{url('categories/4')}}">Artisanat</a>
                        </li>
                    </button>
                    <button class="btn btn-outline-secondary">
                        <li class="nav-item">
                            <a href="{{url('categories/5')}}">
                                <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor"
                            ...
                            <a class="nav-link" href="{{url('categories/5')}}">Culture & Loisirs</a>
                        </li>
                    </button>
                    <button class="btn btn-outline-secondary">
                        <li class="nav-item">
                            <a href="{{url('categories/6')}}">
                                <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor"
                            ...
                            <a class="nav-link" href="{{url('categories/6')}}">Sports</a>
                        </li>
                    </button>
                    <button class="btn btn-outline-secondary">
                        <li class="nav-item">
                            <a href="{{url('categories/7')}}">
                                <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor"
                            ...
                            <a class="nav-link" href="{{url('categories/7')}}">Santé</a>
                        </li>
                    </button>
                    <button class="btn btn-outline-secondary">
                        <li class="nav-item">
                            <a href="{{url('categories/8')}}">
                                <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor"
                            ...
                            <a class="nav-link" href="{{url('categories/8')}}">Services & Divers</a>
                        </li>
                    </button>
                </ul>
            </div>
