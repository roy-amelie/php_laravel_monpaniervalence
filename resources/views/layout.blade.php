            ...
            <div class="d-flex justify-content-center">
                <nav class="navbar navbar-expand-lg navbar-light">
                    <div class="collapse navbar-collapse" id="navbarNav">
                        ...
                        <a role="button" class="btn btn-light border" href="{{url('categories/1')}}">
                        ...
                        <a role="button" class="btn btn-light border" href="{{url('categories/2')}}">
                            <div class="d-flex justify-content-center mb-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35"
                                     fill="currentColor"
                        ...
                        <a role="button" class="btn btn-light border" href="{{url('categories/3')}}">
                            <div class="d-flex justify-content-center mb-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35"
                                     fill="currentColor"
                        ...
                        <a role="button" class="btn btn-light border" href="{{url('categories/4')}}">
                            <div class="d-flex justify-content-center mb-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35"
                                     fill="currentColor"
                        ...
                        <a role="button" class="btn btn-light border" href="{{url('categories/5')}}">
                            <div class="d-flex justify-content-center mb-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35"
                                     fill="currentColor"
                        ...
                        <a role="button" class="btn btn-light border" href="{{url('categories/6')}}">
                            <div class="d-flex justify-content-center mb-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35"
                                     fill="currentColor"
                        ...
                        <a role="button" class="btn btn-light border" href="{{url('categories/7')}}">
                            <div class="d-flex justify-content-center mb-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35"
                                     fill="currentColor"
                        ...
                        <a role="button" class="btn btn-light border" href="{{url('categories/8')}}">
                            <div class="d-flex justify-content-center mb-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35"
                                     fill="currentColor"
